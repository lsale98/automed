...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="d-flex bg-dark" id="registerSelect">
                    <a href="/register" id="reg1" class="card-header active">{{ __('Register as User') }}</a>
                    <a href="/register/servicer" id="reg2" class="card-header">{{ __('Register as Servicer') }}</a>
                </div>

                <div id="registerForm1" class="card-body">
